...
# @app.blob_trigger(arg_name="client", path="jobs",
#                   connection="myiotstock_STORAGE")
# def BlobTriggerWorkerUp1(client: blob.BlobClient):
#     logging.info(
